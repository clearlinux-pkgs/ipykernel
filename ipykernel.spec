...
Source0  : https://files.pythonhosted.org/packages/fc/fd/a0ba26eef615a14c54285b4a62d5e906e0c53000b662e2e4c0b2df7cf004/ipykernel-5.3.4.tar.gz
...
%prep
%setup -q -n ipykernel-5.3.4
cd %{_builddir}/ipykernel-5.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595454399
...
cp %{_builddir}/ipykernel-5.3.4/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

...
Version  : 6.4.0
Release  : 72
URL      : https://files.pythonhosted.org/packages/2b/0b/f36023442db8e8d53678a4e0edc69c7853222944722d0964e165af8d8829/ipykernel-6.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2b/0b/f36023442db8e8d53678a4e0edc69c7853222944722d0964e165af8d8829/ipykernel-6.4.0.tar.gz
...
%prep
%setup -q -n ipykernel-6.4.0
cd %{_builddir}/ipykernel-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631206491
...
cp %{_builddir}/ipykernel-6.4.0/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

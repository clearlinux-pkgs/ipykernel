...
Source0  : https://files.pythonhosted.org/packages/0f/f8/4d209155eaa3ccf4a419bd5768b50c8b6567d5db15863c18d3e481c4d6a0/ipykernel-5.5.4.tar.gz
...
%prep
%setup -q -n ipykernel-5.5.4
cd %{_builddir}/ipykernel-5.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620312209
...
cp %{_builddir}/ipykernel-5.5.4/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

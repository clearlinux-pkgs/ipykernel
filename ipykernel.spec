...
%prep
%setup -q -n ipykernel-5.4.3
cd %{_builddir}/ipykernel-5.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610401988
...
cp %{_builddir}/ipykernel-5.4.3/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

...
Source0  : https://files.pythonhosted.org/packages/98/3c/dd8f27be9d31570395f65bf325a33d5bc9d4d59e5cfbcfe611c6b5cd9074/ipykernel-5.5.0.tar.gz
...
%prep
%setup -q -n ipykernel-5.5.0
cd %{_builddir}/ipykernel-5.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614013436
...
cp %{_builddir}/ipykernel-5.5.0/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

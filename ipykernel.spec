...
Source0  : https://files.pythonhosted.org/packages/8d/65/8cfec48b42d52a6929e9d5fba4e2417cbbbae208c1b764abe9c1b6be1f71/ipykernel-6.5.1.tar.gz
...
BuildRequires : pypi(sphinxcontrib_github_alt)
...
Requires: pypi(sphinxcontrib_github_alt)
...
%prep
%setup -q -n ipykernel-6.5.1
cd %{_builddir}/ipykernel-6.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637367089
...
cp %{_builddir}/ipykernel-6.5.1/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

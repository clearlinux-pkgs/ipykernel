...
Version  : 4.8.0
Release  : 12
URL      : http://pypi.debian.net/ipykernel/ipykernel-4.8.0.tar.gz
Source0  : http://pypi.debian.net/ipykernel/ipykernel-4.8.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1517677697

...
Source0  : https://files.pythonhosted.org/packages/4f/e1/c2e346b3bc3710fa5c63dbd6a6c408a407210fbb15367f06dbd55ea3765b/ipykernel-5.3.0.tar.gz
...
%prep
%setup -q -n ipykernel-5.3.0
cd %{_builddir}/ipykernel-5.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589985646
...
cp %{_builddir}/ipykernel-5.3.0/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

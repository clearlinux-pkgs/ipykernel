...
Source0  : https://files.pythonhosted.org/packages/4f/fe/2e411e2f2fba2318957e34694867e9d9b63811cd1aecff25984f31e35de0/ipykernel-6.4.1.tar.gz
...
%prep
%setup -q -n ipykernel-6.4.1
cd %{_builddir}/ipykernel-6.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631282731
...
cp %{_builddir}/ipykernel-6.4.1/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

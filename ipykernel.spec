...
%prep
%setup -q -n ipykernel-6.0.3
cd %{_builddir}/ipykernel-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626730308
...
cp %{_builddir}/ipykernel-6.0.3/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

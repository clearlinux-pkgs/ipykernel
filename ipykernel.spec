...
Source0  : https://files.pythonhosted.org/packages/f8/50/65b2d779ca6985e2b166cb3ef0326a5267c886a0f420c7c1b476b41e7741/ipykernel-5.3.2.tar.gz
...
%prep
%setup -q -n ipykernel-5.3.2
cd %{_builddir}/ipykernel-5.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594219983
...
cp %{_builddir}/ipykernel-5.3.2/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

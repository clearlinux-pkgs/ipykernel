...
Source0  : https://files.pythonhosted.org/packages/79/fc/89a1f0f560cf082226ed404d7a876c77519f6af84fd482551c862183c509/ipykernel-6.3.1.tar.gz
...
%prep
%setup -q -n ipykernel-6.3.1
cd %{_builddir}/ipykernel-6.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630625771
...
cp %{_builddir}/ipykernel-6.3.1/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

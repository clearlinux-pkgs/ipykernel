...
%prep
%setup -q -n ipykernel-5.4.2
cd %{_builddir}/ipykernel-5.4.2
...
cp %{_builddir}/ipykernel-5.4.2/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

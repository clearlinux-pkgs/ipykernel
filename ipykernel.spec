...
Source0  : https://files.pythonhosted.org/packages/6a/9d/7b8f426f6ad54303a2bfc080816f6adc48eb9ebab50927bbe65b4d7d587b/ipykernel-5.5.5.tar.gz
...
%prep
%setup -q -n ipykernel-5.5.5
cd %{_builddir}/ipykernel-5.5.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620918170
...
cp %{_builddir}/ipykernel-5.5.5/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

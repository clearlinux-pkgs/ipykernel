...
Version  : 6.0.1
Release  : 65
URL      : https://files.pythonhosted.org/packages/ed/8e/f652f8db2467782c137cd31b2b9fe4a305500e759d15fb0523fa8eeede29/ipykernel-6.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ed/8e/f652f8db2467782c137cd31b2b9fe4a305500e759d15fb0523fa8eeede29/ipykernel-6.0.1.tar.gz
...
%prep
%setup -q -n ipykernel-6.0.1
cd %{_builddir}/ipykernel-6.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625583008
...
cp %{_builddir}/ipykernel-6.0.1/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

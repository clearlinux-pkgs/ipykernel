...
Source0  : https://files.pythonhosted.org/packages/c1/43/a7c6398e3ca3748781f7cd13c1b0d17725ee5bd3c1df39a3e8d66341ca3a/ipykernel-5.2.1.tar.gz
...
%prep
%setup -q -n ipykernel-5.2.1
cd %{_builddir}/ipykernel-5.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587055335
...
cp %{_builddir}/ipykernel-5.2.1/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f

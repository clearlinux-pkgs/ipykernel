...
Source0  : https://files.pythonhosted.org/packages/d0/40/34a363757519c295218d6b1ceba93d1af976821d9f36672512e9401b7c94/ipykernel-6.2.0.tar.gz
...
%prep
%setup -q -n ipykernel-6.2.0
cd %{_builddir}/ipykernel-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629128839
...
cp %{_builddir}/ipykernel-6.2.0/COPYING.md %{buildroot}/usr/share/package-licenses/ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f
